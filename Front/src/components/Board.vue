...
// pero por ahora dejémoslo aquí para no confundirte más).
...
<template>
 <div class="board">
    <Column
        ...
        @update:notes="(newNotes) => handleUpdateNotes('todo', newNotes)"
    ...
    <Column
        ...
        @update:notes="(newNotes) => handleUpdateNotes('doing', newNotes)"
    ...
    <Column
        ...
        @update:notes="(newNotes) => handleUpdateNotes('done', newNotes)"
